...
def aunthentication():
    ...
    client_secret_path = CLIENT_SECRETS_PATH
...
if __name__ == '__main__':
    ...
    '''prepare_and_send_email(sender='caiews20002@glbitm.ac.in', 
                           recipient='caiews20002@glbitm.ac.in',
                           subject= 'Greeting from Aparnesh.', 
                           message_text= 'Hello, this is a test email from Aparnesh',
